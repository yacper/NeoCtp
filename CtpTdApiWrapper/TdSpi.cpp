...
//extern CBOnRspQryTrade cbRspQryTrade;	///请求查询成交响应
//extern CBOnRspQryInvestorPosition cbRspQryInvestorPosition;	///请求查询投资者持仓响应
...
//extern CBOnRspQryInstrument cbRspQryInstrument;	///请求查询合约响应
