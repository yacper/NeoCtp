...
namespace NeoCtp
{
	public class CtpTdApi2:CtpTdApi, ICtpTdApi2, ICtpTdSpi
	{
#region ICtpTdSpi
			...
			ref CThostFtdcRspInfoField pRspInfo, int nRequestID, bool bIsLast)
		{
			...
			if (!bIsLast)
			{
				...
				else
				{
					...
					{
						Rsp = pRspInfo,
						Rsp1 = new List<CThostFtdcInvestorPositionField>() { pInvestorPosition },
					};

					_dataDict.TryAdd(nRequestID, rsp);
				}

				rsp.Rsp1.Add(pInvestorPosition);
			}
			else
			{
