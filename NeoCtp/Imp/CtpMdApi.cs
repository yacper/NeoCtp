...
namespace NeoCtp
{
	public partial class CtpMdApi : ObservableObject, ICtpMdApi
	{
...
#region C&D
        public              CtpMdApi(string pszFlowPath = "CtpFiles", bool bIsUsingUdp = false, bool bIsMulticast = false)
        {
  ...
  //      public              CtpMdApi(string frontAddr, string brokerID, string account, string psw)
	 //       : this()
		//{
