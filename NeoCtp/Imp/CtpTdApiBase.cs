...
public partial class CtpTdApiBase : ObservableObject, ICtpTdApiBase
{
    ...
    public int MaxOrderRef { get => MaxOrderRef_; }
    ...
    public void RegisterSpi(ICtpTdSpi pSpi) { TdSpi_ = pSpi; }
    ...
    public void RegisterNameServer(string pszNsAddress) { TdApiCalls.RegisterFront(ApiHandle_, pszNsAddress); }
    ...
    public void SubscribePrivateTopic(THOST_TE_RESUME_TYPE nResumeType) { TdApiCalls.SubscribePrivateTopic(ApiHandle_, nResumeType); }
    ...
    public void SubscribePublicTopic(THOST_TE_RESUME_TYPE nResumeType) { TdApiCalls.SubscribePublicTopic(ApiHandle_, nResumeType); }
...
#region C&D
    ...
    protected virtual void _CbOnHeartBeatWarning(int nTimeLapse) { TdSpi_?.OnHeartBeatWarning(nTimeLapse); }
    ...
    ///请求查询投资者持仓明细响应
    private void _CBRspQryInvestorPositionCombineDetail(ref CThostFtdcInvestorPositionCombineDetailField pInvestorPositionCombineDetail, ref CThostFtdcRspInfoField pRspInfo, int nRequestID,
        bool                                                                                             bIsLast)
    {
    ...
    ///错误应答
    private void _CBOnRspError(ref CThostFtdcRspInfoField pRspInfo, int nRequestID, bool bIsLast) { TdSpi_?.OnRspError(ref pRspInfo, nRequestID, bIsLast); }

    ///报单通知
    private void _CBOnRtnOrder(ref CThostFtdcOrderField pOrder) { TdSpi_?.OnRtnOrder(ref pOrder); }

    ///成交通知
    private void _CBOnRtnTrade(ref CThostFtdcTradeField pTrade) { TdSpi_?.OnRtnTrade(ref pTrade); }

    ///报单录入错误回报
    private void _CBOnErrRtnOrderInsert(ref CThostFtdcInputOrderField pInputOrder, ref CThostFtdcRspInfoField pRspInfo) { TdSpi_?.OnErrRtnOrderInsert(ref pInputOrder, ref pRspInfo); }

    ///报单操作错误回报
    private void _CBOnErrRtnOrderAction(ref CThostFtdcOrderActionField pOrderAction, ref CThostFtdcRspInfoField pRspInfo) { TdSpi_?.OnErrRtnOrderAction(ref pOrderAction, ref pRspInfo); }

    ///合约交易状态通知
    private void _CBRtnInstrumentStatus(ref CThostFtdcInstrumentStatusField pInstrumentStatus) { TdSpi_?.OnRtnInstrumentStatus(ref pInstrumentStatus); }

    ///交易通知
    private void _CBRtnTradingNotice(ref CThostFtdcTradingNoticeInfoField pTradingNoticeInfo) { TdSpi_?.OnRtnTradingNotice(ref pTradingNoticeInfo); }

    ///提示条件单校验错误
    private void _CBRtnErrorConditionalOrder(ref CThostFtdcErrorConditionalOrderField pErrorConditionalOrder) { TdSpi_?.OnRtnErrorConditionalOrder(ref pErrorConditionalOrder); }

    ///执行宣告通知
    private void _CBRtnExecOrder(ref CThostFtdcExecOrderField pExecOrder) { TdSpi_?.OnRtnExecOrder(ref pExecOrder); }
    ...
    ///询价录入错误回报
    private void _CBErrRtnForQuoteInsert(ref CThostFtdcInputForQuoteField pInputForQuote, ref CThostFtdcRspInfoField pRspInfo) { TdSpi_?.OnErrRtnForQuoteInsert(ref pInputForQuote, ref pRspInfo); }

    ///报价通知
    private void _CBRtnQuote(ref CThostFtdcQuoteField pQuote) { TdSpi_?.OnRtnQuote(ref pQuote); }

    ///报价录入错误回报
    private void _CBErrRtnQuoteInsert(ref CThostFtdcInputQuoteField pInputQuote, ref CThostFtdcRspInfoField pRspInfo) { TdSpi_?.OnErrRtnQuoteInsert(ref pInputQuote, ref pRspInfo); }

    ///报价操作错误回报
    private void _CBErrRtnQuoteAction(ref CThostFtdcQuoteActionField pQuoteAction, ref CThostFtdcRspInfoField pRspInfo) { TdSpi_?.OnErrRtnQuoteAction(ref pQuoteAction, ref pRspInfo); }

    ///询价通知
    private void _CBRtnForQuoteRsp(ref CThostFtdcForQuoteRspField pForQuoteRsp) { TdSpi_?.OnRtnForQuoteRsp(ref pForQuoteRsp); }

    ///保证金监控中心用户令牌
    private void _CBRtnCFMMCTradingAccountToken(ref CThostFtdcCFMMCTradingAccountTokenField pCFMMCTradingAccountToken) { TdSpi_?.OnRtnCFMMCTradingAccountToken(ref pCFMMCTradingAccountToken); }
    ...
    ///期权自对冲通知
    private void _CBRtnOptionSelfClose(ref CThostFtdcOptionSelfCloseField pOptionSelfClose) { TdSpi_?.OnRtnOptionSelfClose(ref pOptionSelfClose); }
    ...
    ///申请组合通知
    private void _CBRtnCombAction(ref CThostFtdcCombActionField pCombAction) { TdSpi_?.OnRtnCombAction(ref pCombAction); }
    ...
    ///银行发起银行资金转期货通知
    private void _CBRtnFromBankToFutureByBank(ref CThostFtdcRspTransferField pRspTransfer) { TdSpi_?.OnRtnFromBankToFutureByBank(ref pRspTransfer); }

    ///银行发起期货资金转银行通知
    private void _CBRtnFromFutureToBankByBank(ref CThostFtdcRspTransferField pRspTransfer) { TdSpi_?.OnRtnFromFutureToBankByBank(ref pRspTransfer); }

    ///银行发起冲正银行转期货通知
    private void _CBRtnRepealFromBankToFutureByBank(ref CThostFtdcRspRepealField pRspRepeal) { TdSpi_?.OnRtnRepealFromBankToFutureByBank(ref pRspRepeal); }

    ///银行发起冲正期货转银行通知
    private void _CBRtnRepealFromFutureToBankByBank(ref CThostFtdcRspRepealField pRspRepeal) { TdSpi_?.OnRtnRepealFromFutureToBankByBank(ref pRspRepeal); }

    ///期货发起银行资金转期货通知
    private void _CBRtnFromBankToFutureByFuture(ref CThostFtdcRspTransferField pRspTransfer) { TdSpi_?.OnRtnFromBankToFutureByFuture(ref pRspTransfer); }

    ///期货发起期货资金转银行通知
    private void _CBRtnFromFutureToBankByFuture(ref CThostFtdcRspTransferField pRspTransfer) { TdSpi_?.OnRtnFromFutureToBankByFuture(ref pRspTransfer); }

    ///系统运行时期货端手工发起冲正银行转期货请求，银行处理完毕后报盘发回的通知
    private void _CBRtnRepealFromBankToFutureByFutureManual(ref CThostFtdcRspRepealField pRspRepeal) { TdSpi_?.OnRtnRepealFromBankToFutureByFutureManual(ref pRspRepeal); }

    ///系统运行时期货端手工发起冲正期货转银行请求，银行处理完毕后报盘发回的通知
    private void _CBRtnRepealFromFutureToBankByFutureManual(ref CThostFtdcRspRepealField pRspRepeal) { TdSpi_?.OnRtnRepealFromFutureToBankByFutureManual(ref pRspRepeal); }

    ///期货发起查询银行余额通知
    private void _CBRtnQueryBankBalanceByFuture(ref CThostFtdcNotifyQueryAccountField pNotifyQueryAccount) { TdSpi_?.OnRtnQueryBankBalanceByFuture(ref pNotifyQueryAccount); }
    ...
    private void _CBRtnRepealFromBankToFutureByFuture(ref CThostFtdcRspRepealField pRspRepeal) { TdSpi_?.OnRtnRepealFromBankToFutureByFuture(ref pRspRepeal); }

    ///期货发起冲正期货转银行请求，银行处理完毕后报盘发回的通知
    private void _CBRtnRepealFromFutureToBankByFuture(ref CThostFtdcRspRepealField pRspRepeal) { TdSpi_?.OnRtnRepealFromFutureToBankByFuture(ref pRspRepeal); }
    ...
    ///银行发起银期开户通知
    private void _CBRtnOpenAccountByBank(ref CThostFtdcOpenAccountField pOpenAccount) { TdSpi_?.OnRtnOpenAccountByBank(ref pOpenAccount); }

    ///银行发起银期销户通知
    private void _CBRtnCancelAccountByBank(ref CThostFtdcCancelAccountField pCancelAccount) { TdSpi_?.OnRtnCancelAccountByBank(ref pCancelAccount); }

    ///银行发起变更银行账号通知
    private void _CBRtnChangeAccountByBank(ref CThostFtdcChangeAccountField pChangeAccount) { TdSpi_?.OnRtnChangeAccountByBank(ref pChangeAccount); }
