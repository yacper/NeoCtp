...
namespace NeoCtp
{
	public interface ICtpTdSpi
	{
		...
		///查询最大报单数量响应
		void OnRspQueryMaxOrderVolume(ref CThostFtdcQryMaxOrderVolumeField pQueryMaxOrderVolume, ref CThostFtdcRspInfoField pRspInfo, int nRequestID, bool bIsLast);
